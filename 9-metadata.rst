...
#.	If a book title contains numbers or abbreviations, a :html:`<meta id="alternative-title" id="se:alternative-title" refines="#title">` element is placed after the main title block, containing the title with expanded or alternate spelling to facilitate possible search queries.
	...
	.. code:: html
		...
		<meta id="alternative-title" id="se:alternative-title" refines="#title">Around the World in 80 Days</meta>

	.. code:: html

		<dc:title id="title">File No. 113</dc:title>
		<meta property="file-as" refines="#title">File No. 113</meta>
		<meta id="alternative-title" id="se:alternative-title" refines="#title">File Number One Hundred and Thirteen</meta>
...
.. tip::
	...
	The :bash:`se print-manifest-and-spine` tool generates a complete manifest that can be copied-and-pasted into the ebook’s metadata file.
...
.. tip::
	...
	The :bash:`se print-manifest-and-spine` tool generates a draft of the spine by making some educated guesses as to the reading order. The tool’s output is never 100% correct; manual review of the output is required, and adjustments may be necessary to correct the reading order.
